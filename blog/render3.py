"""Render blog3.md -> blog3.html with the same clean style as blogs #1/#2.
Images resolve because blog3.html lives next to the shots3/ folder."""
import re
import markdown
...
<body><div class="wrap">
<div class="meta">Agents of SigNoz hackathon · blog #3 (flagship) · preview</div>
__BODY__
</div></body></html>"""
